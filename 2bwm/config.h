...
static const char *colors[] = {"#4b5262","#434a5a","#FFCB6B","#FF5370","#F07178","#2f343f","#000000"};
...
///--Menus and Programs---///
static const char *menucmd[]       = { "rofi","-show","run","-show-icons","-sidebar-mode","-terminal","urxvt","-font","SF Pro Display 11",  NULL };
